<?php
    ...
    // create the databse woth the name toucantech that i will use for this demo
    ...
    // create the table where i'm going to store memvers
    ...
    // create the table where i'm going to store schools
    ...
    // create the table where i'm going to store associations
